package com.example.volumereplacer.data
...
import com.example.volumereplacer.data.model.OverlayAction
import com.example.volumereplacer.data.model.OverlayPosition
import com.example.volumereplacer.data.model.UserPreferences
    ...
    val userPreferencesFlow: Flow<UserPreferences> = context.dataStore.data.map { prefs ->
        UserPreferences(
            ...
            tapAction = OverlayAction.fromKey(
                prefs[Keys.TAP_ACTION] ?: OverlayAction.VolumeUp.key,
            ),
            longPressAction = OverlayAction.fromKey(
                prefs[Keys.LONG_PRESS_ACTION] ?: OverlayAction.Mute.key,
            ),
        )
    }
